...
class ExceptionApiControllerTest {
    ...
    fun postTest() {
        ...
        val userRequest = UserRequest().apply {
            this.name = "goose"
            this.age = 10
            this.phoneNumber = "010-0000-2222"
            this.address = "111"
            this.email = "www@gmail.com"
        ...
        mockMvc.perform(
            ...
            jsonPath("\$.name").value("goose")
        ).andExpect(
            jsonPath("\$.age").value("10")
        ).andExpect(
            jsonPath("\$.phoneNumber").value("010-0000-2222")
        ).andExpect(
            jsonPath("\$.address").value("111")
        ).andExpect(
            jsonPath("\$.email").value("www@gmail.com")
        ).andExpect(
